...
- **[Topping](/guides/topping-fim-mainlining)** — snip the main growing tip above the 4th–5th node; the plant redirects to two main colas instead of one
- **[LST](/guides/low-stress-training-lst)** — bend and tie branches outward so light reaches everything
- Remove growth that will never see light: the spindly bottom third

## When to flip

Plants roughly **double in height** during the flowering stretch. Flip to 12/12 when your plant fills about half its allotted final height and the canopy is even. For most indoor grows that's week 6–8 of veg. See [the flip guide](/guides/the-flip-12-12) for the full checklist.

If leaves are yellowing or showing spots during veg, check the [nutrient deficiency chart](/guides/nutrient-deficiency-chart) — but start with [pH](/guides/watering-ph-fundamentals) before adding anything.
